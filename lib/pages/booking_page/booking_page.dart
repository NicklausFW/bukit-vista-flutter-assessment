import 'package:bukit_vista_flutter_assessment/bloc/booking_tabbar/booking_tabbar_bloc.dart';
...
import '../../view_models/guest_viewmodel.dart';
...
class _BookingPageState extends State<BookingPage> {
  ...
  Widget build(BuildContext context) {
    return bookingPageGuestDetailPressed == false
        ? BlocBuilder<BookingTabBarBloc, BookingTabBarState>(
                                ...
                                return GestureDetector(
                                  ...
                                  child: AnimatedContainer(
                                    ...
                                    decoration: BoxDecoration(
                                        color:
                                            BookingTabBar.currentTabBarIndex ==
                                                    index
                                                ? Color(0xff1076bc)
                                                : Colors.white,
                                        border: Border.all(
